    ...
    doAjaxAddToCart: function(variant_id, quantity, title, image) {
      ...
      $.ajax({
        ...
        error: function(xhr, text) {
          ...
          $('.error-message').html('<i class="material-icons">info</i> '+ $.parseJSON(xhr.responseText).description);
          ...
          for (var j = 0; j < product.variants.length; j++) {
            ...
            if (optionValues.indexOf(value) < 0) {
              ...
              if (variant.available) {
                ...
                $('.quick-view .swatch[data-option-index="' + i + '"] .' + valueHandle).removeClass('soldout').addClass('available xyzs').find(':radio').removeAttr('disabled');
              }
    ...
    initaddjs: function(){
      $(document).ready(function() {
        ...
        $('.tabs-menu_btn').click(function(e){
          e.preventDefault();
          $(this).next().toggleClass("tabs-open");
        });
